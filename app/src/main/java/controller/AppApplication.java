...
public class AppApplication extends Application {
    ...
    public static void setAlert(ArrayList<Integer> alert) {
        AppApplication.alert = alert;
    }
    ...
    public static void destroyAllAlerts() {
        //Log.w("taskalertonDestryou","tellkkll");
        ArrayList<Integer> alerts = AppApplication.getAlert();
        TaskAlertController tac = new TaskAlertController();
        if(!alerts.isEmpty()){
